...
// Les sources importent leurs voisines en « .js », comme l'exige la résolution
// NodeNext de tsc ; esbuild s'en accommode, le dépouillement de types de Node
// non — il cherche un .js qui n'existe qu'après le build. On réécrit donc vers
// le .ts quand il existe, sans toucher aux sources pour les seuls tests.
registerHooks({
